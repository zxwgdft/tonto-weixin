 ...
 *
 */
public class WeChatAccessTokenService implements WeChatService{
	...
	public String getToken() {
		...
		if (System.currentTimeMillis() - lastAccessTime > keepTime) {
			...
			synchronized (WeChatAccessTokenService.class) {
				if (System.currentTimeMillis() - lastAccessTime > keepTime) {
					updateAccessToken();
				}
			}
	...
	private final static WeChatAccessTokenService tokenService = new WeChatAccessTokenService();
